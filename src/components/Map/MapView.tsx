...
function customizeStyle(map: maplibregl.Map) {
  ...
  for (const layer of style.layers) {
    try {
      ...
      // ── Boundaries: hide ALL CARTO boundaries ──
      // Natural Earth GeoJSON overlay provides accurate country borders;
      // CARTO tile boundaries conflict (especially for disputed territories)
